...
namespace toucan
{
        ...
        _path(path)
    {
        ...
        auto otioTimeline = OTIO_NS::SerializableObject::Retainer<OTIO_NS::Timeline>(
        ...
        _thumbnailGenerator = std::make_shared<ThumbnailGenerator>(_timeline, _host);
        ...
        _graph = std::make_shared<ImageGraph>(_timeline, graphOptions);
    ...
    void Document::_render()
    {
        ...
        if (_rootNode->get())
        {
            ...
            _imageBuf = _rootNode->get()->exec(_currentTime - timeRange.start_time());
